...
module.exports = {
    ...
    uiTestFunc: browser => {
        ...
        browser
            .setValue(selectors.propLocationScreen.cityName, data.uiTest.propLocationScreen.cityZipInput)
        ...
        browser.assert.attributeEquals(selectors.purchPriceDwnPaymntScreen.estPurchPrice, 'placeholder', data.uiTest.purchPriceDwnPaymntScreen.estPurchPrice)
            .setValue(selectors.purchPriceDwnPaymntScreen.estPurchPrice, '$1')
        ...
        browser
            ...
            .setValue(selectors.purchPriceDwnPaymntScreen.downPayment, '$1')
        ...
        browser.expect.element(selectors.bankruptcyScreen.neither).text.to.equal(data.uiTest.bankruptcyScreen.neither)
        ...
        browser
            .setValue(selectors.addressScreen.lineOne, '12345 W 1234 N')
            .setValue(selectors.addressScreen.lineThree, 'Ogden, UT 84401')
        ...
        browser
            .setValue(selectors.nameScreen.firstName, 'A')
            .setValue(selectors.nameScreen.lastName, 'B')
            .setValue(selectors.nameScreen.email, 'test@gmail.com')
        ...
        browser.expect.element(selectors.overViewScreen.name).text.to.contain(data.uiTest.overViewScreen.name)
        browser.expect.element(selectors.overViewScreen.nameOutput).text.to.equal(data.uiTest.overViewScreen.nameOutput)
        browser.expect.element(selectors.overViewScreen.email).text.to.contain(data.uiTest.overViewScreen.email)
        browser.expect.element(selectors.overViewScreen.emailOutput).text.to.equal(data.uiTest.overViewScreen.emailOutput)
        browser.expect.element(selectors.overViewScreen.loan).text.to.contain(data.uiTest.overViewScreen.loanType)
        browser.expect.element(selectors.overViewScreen.loanOutput).text.to.equal(data.uiTest.overViewScreen.loanTypeOutput)
        browser.expect.element(selectors.overViewScreen.property).text.to.contain(data.uiTest.overViewScreen.propertyType)
        browser.expect.element(selectors.overViewScreen.propertyOutput).text.to.equal(data.uiTest.overViewScreen.propertyTypeOutput)
        browser.expect.element(selectors.overViewScreen.city).text.to.contain(data.uiTest.overViewScreen.propLocation)
        browser.expect.element(selectors.overViewScreen.cityOutput).text.to.equal(data.uiTest.overViewScreen.propLocationOutput)
        browser.expect.element(selectors.overViewScreen.propType).text.to.contain(data.uiTest.overViewScreen.purchaseReason)
        browser.expect.element(selectors.overViewScreen.propTypeOutput).text.to.equal(data.uiTest.overViewScreen.purchaseReasonOutput)
        browser.expect.element(selectors.overViewScreen.found).text.to.contain(data.uiTest.overViewScreen.propLocated)
        browser.expect.element(selectors.overViewScreen.foundOutput).text.to.equal(data.uiTest.overViewScreen.propLocatedOutput)
        browser.expect.element(selectors.overViewScreen.agent).text.to.contain(data.uiTest.overViewScreen.agent)
        browser.expect.element(selectors.overViewScreen.agentOutput).text.to.equal(data.uiTest.overViewScreen.agentOutput)
        browser.expect.element(selectors.overViewScreen.cost).text.to.contain(data.uiTest.overViewScreen.price)
        browser.expect.element(selectors.overViewScreen.costOutput).text.to.equal(data.uiTest.overViewScreen.priceOutput)
        browser.expect.element(selectors.overViewScreen.downPayment).text.to.contain(data.uiTest.overViewScreen.downPayment)
        ...
        browser.expect.element(selectors.overViewScreen.credit).text.to.contain(data.uiTest.overViewScreen.credit)
        browser.expect.element(selectors.overViewScreen.creditOutput).text.to.equal(data.uiTest.overViewScreen.creditOutput)
        browser.expect.element(selectors.overViewScreen.bankruptcy).text.to.contain(data.uiTest.overViewScreen.creditHistory)
        browser.expect.element(selectors.overViewScreen.bankruptcyOutput).text.to.equal(data.uiTest.overViewScreen.creditHistoryOutput)
        browser.expect.element(selectors.overViewScreen.address).text.to.contain(data.uiTest.overViewScreen.address)
        ...
        browser.click(selectors.thankYouScreen.homeBtn)
            .waitForElementVisible(selectors.homeScreen.homeTitleText, 3000)
    },
